...
class Joint:
    ...
    def __init__(self, config_dict = None):
        #TODO: change init code to allow dictionary unpacking.
        if config_dict != None:
            ...
            self.joint_name = config_dict["name"]
            self.initial_dh_dict = config_dict["initial_dh_dict"]
...
class PrismaticJoint(Joint):
    ...
    def convert_distance_to_pwm(self, distance):
        pass

    def convert_pwm_to_distance(self, pwm):
        pass
...
if __name__ == "__main__":
    ...
    shoulder_dh_matrix = create_dh_matrix_from_dict(shoulder_joint.initial_dh_dict)
    print(shoulder_dh_matrix)
    final_vector = np.dot(shoulder_dh_matrix, vector)    
    print(final_vector)
